    ...
    {({starIcon, formattedAssetName, formattedAssetLink, formattedAmount, formattedPolicy}) => {
      return (
        <div
          ...
          data-cy={
            props.type === AssetFamily.TOKEN ? 'Send Asset dropdown token item' : 'Send Asset dropdown ADA item'
          }
        >
          <div className="multi-asset-name-amount">
            ...
            <div
              ...
              data-cy={
                props.type === AssetFamily.TOKEN ? 'Send Asset token quantity' : 'Send Asset ADA quantity'
              }
            >{formattedAmount}</div>
          </div>
          {formattedPolicy}
    ...
    <Fragment>
      ...
      <div className="input-wrapper">
        <input
          ...
          data-cy={`${isModal ? 'Account ' : ''}Send amount field`}
  ...
  return (
    <div className="send card" ref={sendCardDiv}>
      ...
      <div className="send-values">
        ...
        <div className="send-fee" data-cy="Send fee amount">
        ...
        {selectedAsset.type === AssetFamily.TOKEN && (
          <Fragment>
            ...
            <div className="send-fee" data-cy="Send asset min ada amount">
