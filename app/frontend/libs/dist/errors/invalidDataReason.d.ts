export declare enum InvalidDataReason {
    ...
    INPUT_WITH_PATH_WHEN_SIGNING_AS_POOL_OWNER = "inputs should not contain the witness path if signing stake pool certificate as an owner",
    ...
    POOL_REGISTRATION_INVALID_POOL_KEY_HASH = "invalid pool key hash in a pool registration certificate",
    ...
    POOL_MARGIN_INVALID_MARGIN_DENOMINATOR = "pool margin denominator must be a value between 1 and 10^15",
    POOL_REGISTRATION_INVALID_REWARD_ACCOUNT = "invalid reward account in a pool registration certificate",
    POOL_REGISTRATION_OWNERS_TOO_MANY = "too many owners in a pool registration certificate",
    POOL_REGISTRATION_OWNERS_SINGLE_PATH = "there should be exactly one owner given by path in a pool registration certificate",
